...
df <- read_csv("data/clean_data/AqFl2_qPCR_ref_PI.csv", col_names = T, na = "") 
...
ggsave('analysis/exploratory_analysis/qPCR_ref_PI_boxPlot.pdf', 
       units = "in", dpi = 300)
...
ggsave('analysis/exploratory_analysis/qPCR_ref_PI_barPlot.pdf', 
       units = "in", dpi = 300)
